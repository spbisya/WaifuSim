...
public class LAppDefine {
    ...
    public static final String MODEL_HARU = "11233123/model.model.json";
    ...
    public static final String MODEL_SHIZUKU = "live2d/haru/haru.model.json";
    public static final String MODEL_WANKO = "Mirai/model.json";
